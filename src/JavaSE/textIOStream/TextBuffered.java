 ...
 * two.txt的地址 src\JavaSE.textIOStream\two.txt
 *
...
public class TextBuffered {
    public static void main(String[] args) throws IOException {
        ...
        FileReader fr = new FileReader("src\\JavaSE.textIOStream\\two.txt");
        BufferedReader bufR = new BufferedReader(fr);
        FileWriter fw = new FileWriter("src\\JavaSE.textIOStream\\copyByBuffer.txt");
